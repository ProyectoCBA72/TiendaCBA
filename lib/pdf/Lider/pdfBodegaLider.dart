...
class PdfBodegaLiderScreen extends StatefulWidget {
  const PdfBodegaLiderScreen({
    super.key,
  ...
  @override
  State<PdfBodegaLiderScreen> createState() =>
      _PdfBodegaLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfBodegaLiderScreenState extends State<PdfBodegaLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfBodegaLiderScreenState({
    required this.usuario,
    required this.registro,
  });
