...
class PdfProduccionLiderScreen extends StatefulWidget {
  const PdfProduccionLiderScreen({
    super.key,
  ...
  @override
  State<PdfProduccionLiderScreen> createState() =>
      _PdfProduccionLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfProduccionLiderScreenState extends State<PdfProduccionLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfProduccionLiderScreenState({
    required this.usuario,
    required this.registro,
  });
