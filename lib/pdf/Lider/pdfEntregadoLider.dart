...
class PdfEntregadoLiderScreen extends StatefulWidget {
  const PdfEntregadoLiderScreen({
    super.key,
  ...
  @override
  State<PdfEntregadoLiderScreen> createState() =>
      _PdfEntregadoLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfEntregadoLiderScreenState extends State<PdfEntregadoLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEntregadoLiderScreenState({
    required this.usuario,
    required this.registro,
  });
