...
class PdfFacturaLiderScreen extends StatefulWidget {
  const PdfFacturaLiderScreen({
    super.key,
  ...
  @override
  State<PdfFacturaLiderScreen> createState() =>
      _PdfFacturaLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfFacturaLiderScreenState extends State<PdfFacturaLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfFacturaLiderScreenState({
    required this.usuario,
    required this.registro,
  });
