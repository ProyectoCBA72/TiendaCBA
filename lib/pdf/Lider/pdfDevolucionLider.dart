...
class PdfDevolucionLiderScreen extends StatefulWidget {
  const PdfDevolucionLiderScreen({
    super.key,
  ...
  @override
  State<PdfDevolucionLiderScreen> createState() =>
      _PdfDevolucionLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfDevolucionLiderScreenState extends State<PdfDevolucionLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfDevolucionLiderScreenState({
    required this.usuario,
    required this.registro,
  });
