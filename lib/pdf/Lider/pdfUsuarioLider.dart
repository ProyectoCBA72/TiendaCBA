...
class PdfUsuarioLiderScreen extends StatefulWidget {
  const PdfUsuarioLiderScreen({
    super.key,
  ...
  @override
  State<PdfUsuarioLiderScreen> createState() =>
      _PdfUsuarioLiderScreenState(usuario: usuario, registro: registro);
}

// Estado privado para PdfPageScreen.
class _PdfUsuarioLiderScreenState extends State<PdfUsuarioLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfUsuarioLiderScreenState({
    required this.usuario,
    required this.registro,
  });
