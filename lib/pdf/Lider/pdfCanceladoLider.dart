...
class PdfCanceladoLiderScreen extends StatefulWidget {
  const PdfCanceladoLiderScreen({
    super.key,
  ...
  @override
  State<PdfCanceladoLiderScreen> createState() =>
      _PdfCanceladoLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfCanceladoLiderScreenState extends State<PdfCanceladoLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfCanceladoLiderScreenState({
    required this.usuario,
    required this.registro,
  });
