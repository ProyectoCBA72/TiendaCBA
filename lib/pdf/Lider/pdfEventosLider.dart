...
class PdfEventosLiderScreen extends StatefulWidget {
  const PdfEventosLiderScreen({
    super.key,
  ...
  @override
  State<PdfEventosLiderScreen> createState() =>
      _PdfEventosLiderScreenState(usuario: usuario, registro: registro);
}

class _PdfEventosLiderScreenState extends State<PdfEventosLiderScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEventosLiderScreenState({
    required this.usuario,
    required this.registro,
  });
