...
class PdfProduccionUnidadScreen extends StatefulWidget {
  const PdfProduccionUnidadScreen({
    super.key,
  ...
  @override
  State<PdfProduccionUnidadScreen> createState() =>
      _PdfProduccionUnidadScreenState(usuario: usuario, registro: registro);
}

class _PdfProduccionUnidadScreenState extends State<PdfProduccionUnidadScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfProduccionUnidadScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de producción',
    );
