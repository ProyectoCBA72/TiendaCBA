...
class PdfEventosUnidadScreen extends StatefulWidget {
  const PdfEventosUnidadScreen({
    super.key,
  ...
  @override
  State<PdfEventosUnidadScreen> createState() =>
      _PdfEventosUnidadScreenState(usuario: usuario, registro: registro);
}

class _PdfEventosUnidadScreenState extends State<PdfEventosUnidadScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEventosUnidadScreenState({
    required this.usuario,
    required this.registro,
  });
