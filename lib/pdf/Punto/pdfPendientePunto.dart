...
class PdfPendientePuntoScreen extends StatefulWidget {
  const PdfPendientePuntoScreen({
    super.key,
  ...
  @override
  State<PdfPendientePuntoScreen> createState() =>
      _PdfPendientePuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfPendientePuntoScreenState extends State<PdfPendientePuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfPendientePuntoScreenState({
    required this.usuario,
    required this.registro,
  });
