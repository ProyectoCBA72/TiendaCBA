...
class PdfEventosPuntoScreen extends StatefulWidget {
  const PdfEventosPuntoScreen({
    super.key,
  ...
  @override
  State<PdfEventosPuntoScreen> createState() =>
      _PdfEventosPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfEventosPuntoScreenState extends State<PdfEventosPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEventosPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
