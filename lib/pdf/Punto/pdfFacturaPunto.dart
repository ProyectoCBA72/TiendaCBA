...
class PdfFacturaPuntoScreen extends StatefulWidget {
  const PdfFacturaPuntoScreen({
    super.key,
  ...
  @override
  State<PdfFacturaPuntoScreen> createState() =>
      _PdfFacturaPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfFacturaPuntoScreenState extends State<PdfFacturaPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfFacturaPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
