...
class PdfCanceladoPuntoScreen extends StatefulWidget {
  const PdfCanceladoPuntoScreen({
    super.key,
  ...
  @override
  State<PdfCanceladoPuntoScreen> createState() =>
      _PdfCanceladoPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfCanceladoPuntoScreenState extends State<PdfCanceladoPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfCanceladoPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
