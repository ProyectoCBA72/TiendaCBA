...
class PdfEntregadoPuntoScreen extends StatefulWidget {
  const PdfEntregadoPuntoScreen({
    super.key,
  ...
  @override
  State<PdfEntregadoPuntoScreen> createState() =>
      _PdfEntregadoPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfEntregadoPuntoScreenState extends State<PdfEntregadoPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEntregadoPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
