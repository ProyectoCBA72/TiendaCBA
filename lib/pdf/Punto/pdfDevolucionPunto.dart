...
class PdfDevolucionPuntoScreen extends StatefulWidget {
  const PdfDevolucionPuntoScreen({
    super.key,
  ...
  @override
  State<PdfDevolucionPuntoScreen> createState() =>
      _PdfDevolucionPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfDevolucionPuntoScreenState extends State<PdfDevolucionPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfDevolucionPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
