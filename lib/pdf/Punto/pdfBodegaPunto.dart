...
class PdfBodegaPuntoScreen extends StatefulWidget {
  const PdfBodegaPuntoScreen({
    super.key,
  ...
  @override
  State<PdfBodegaPuntoScreen> createState() =>
      _PdfBodegaPuntoScreenState(usuario: usuario, registro: registro);
}

class _PdfBodegaPuntoScreenState extends State<PdfBodegaPuntoScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfBodegaPuntoScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de inventario',
    );
