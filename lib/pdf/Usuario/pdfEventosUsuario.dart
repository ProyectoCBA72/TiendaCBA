...
class PdfEventosUsuarioScreen extends StatefulWidget {
  const PdfEventosUsuarioScreen({
    super.key,
  ...
  @override
  State<PdfEventosUsuarioScreen> createState() =>
      _PdfEventosUsuarioScreenState(usuario: usuario, registro: registro);
}

class _PdfEventosUsuarioScreenState extends State<PdfEventosUsuarioScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEventosUsuarioScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de asistencia a eventos',
    );
