...
class PdfDevolucionUsuarioScreen extends StatefulWidget {
  const PdfDevolucionUsuarioScreen({
    super.key,
  ...
  @override
  State<PdfDevolucionUsuarioScreen> createState() =>
      _PdfDevolucionUsuarioScreenState(usuario: usuario, registro: registro);
}

class _PdfDevolucionUsuarioScreenState extends State<PdfDevolucionUsuarioScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfDevolucionUsuarioScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de devoluciones',
    );
