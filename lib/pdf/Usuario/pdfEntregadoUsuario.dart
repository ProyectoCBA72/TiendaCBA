...
class PdfEntregadoUsuarioScreen extends StatefulWidget {
  const PdfEntregadoUsuarioScreen({
    super.key,
  ...
  @override
  State<PdfEntregadoUsuarioScreen> createState() =>
      _PdfEntregadoUsuarioScreenState(usuario: usuario, registro: registro);
}

class _PdfEntregadoUsuarioScreenState extends State<PdfEntregadoUsuarioScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfEntregadoUsuarioScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de pedidos entregados',
    );
