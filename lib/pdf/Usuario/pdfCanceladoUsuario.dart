...
class PdfCanceladoUsuarioScreen extends StatefulWidget {
  const PdfCanceladoUsuarioScreen({
    super.key,
  ...
  @override
  State<PdfCanceladoUsuarioScreen> createState() =>
      _PdfCanceladoUsuarioScreenState(usuario: usuario, registro: registro);
}

class _PdfCanceladoUsuarioScreenState extends State<PdfCanceladoUsuarioScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registro;

  _PdfCanceladoUsuarioScreenState({
    required this.usuario,
    required this.registro,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de pedidos cancelados',
    );
