...
class ReporteDevolucionesPuntoAgnoPunto extends StatelessWidget {
  ...
  List<DevolucionesAgnoDataPunto> _getDevolucionesDataAgno(
    ...
    // Convertir el mapa a una lista de objetos DevolucionesAgnoDataPunto
    return devolucionesPorAnio.entries
        .map((entry) => DevolucionesAgnoDataPunto(entry.key, entry.value))
        .toList();
  }
