...
import 'package:tienda_app/Dashboard/dashboard/screens/dashboard/components/punto/card_pedido_punto.dart';
...
// Vista donde se llamaran las cards superiores de conteo de pedidos y las organiza que se adapten a todos los dispositivos

class CardsPedidoVendedor extends StatelessWidget {
                ...
                builder:
                  ...
                  if (snapshotPedido.connectionState ==
                    ...
                    for (var p = 0; p < snapshotPunto.data!.length; p++) {
                      for (var r = 0; r < snapshotPedido.data!.length; r++) {
                        if (snapshotPedido.data![r].puntoVenta ==
                            ...
                            snapshotPunto.data![p].id == usuario.puntoVenta &&
                    ...
                    return GridView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: pedidosCardPunto.length,
                      ...
                      itemBuilder: (context, index) =>
                          CardPedidoPunto(info: pedidosCardPunto[index]),
                    );
                  }
                });
          }
