...
class ReporteProductosMasVendidosMesPunto extends StatelessWidget {
  ...
  List<ProduccionVentaDataMesPunto> _getProduccionVentaDataMes(String producto,
      Map<String, Map<String, double>> ventasPorProductoPorMes) {
    final List<ProduccionVentaDataMesPunto> data = [];
    if (ventasPorProductoPorMes.containsKey(producto)) {
      ventasPorProductoPorMes[producto]!.forEach((mes, cantidad) {
        data.add(ProduccionVentaDataMesPunto(mes, cantidad));
      });
    }
    return data;
  }
