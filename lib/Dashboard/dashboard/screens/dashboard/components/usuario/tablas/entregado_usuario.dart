...
class EntregadoUsuario extends StatefulWidget {
  const EntregadoUsuario({super.key});
...
class _EntregadoUsuarioState extends State<EntregadoUsuario> {
  ...
  void initState() {
    ...
    _dataGridSource = EntregadoUsuarioDataGridSource(pedidos: _pedidos);
  }
...
class EntregadoUsuarioDataGridSource extends DataGridSource {
  EntregadoUsuarioDataGridSource({required List<PedidoLider> pedidos}) {
