...
class CanceladoUsuario extends StatefulWidget {
  const CanceladoUsuario({super.key});
...
class _CanceladoUsuarioState extends State<CanceladoUsuario> {
  ...
  void initState() {
    ...
    _dataGridSource = CanceladoUsuarioDataGridSource(pedidos: _pedidos);
  }
...
class CanceladoUsuarioDataGridSource extends DataGridSource {
  CanceladoUsuarioDataGridSource({required List<PedidoLider> pedidos}) {
