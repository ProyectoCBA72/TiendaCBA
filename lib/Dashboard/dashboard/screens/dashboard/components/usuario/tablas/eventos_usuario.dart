...
class EventosUsuario extends StatefulWidget {
  const EventosUsuario({super.key});
...
class _EventosUsuarioState extends State<EventosUsuario> {
  ...
  void initState() {
    ...
    _dataGridSource = EventosUsuarioDataGridSource(eventos: _eventos);
  }
...
class EventosUsuarioDataGridSource extends DataGridSource {
  EventosUsuarioDataGridSource({required List<EventosLiderClase> eventos}) {
