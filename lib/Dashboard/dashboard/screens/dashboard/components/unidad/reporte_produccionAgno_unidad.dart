...
class ReporteProduccionAgnoUnidad extends StatelessWidget {
              ...
              builder:
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<ProduccionModel> produccionesFiltradas = producciones
                      .where((p) =>
                          p.unidadProduccion.id == usuario.unidadProduccion)
                      .toList();
                    ...
                    series: produccionesFiltradas
                        .map((produccion) =>
                            StepLineSeries<ProduccionAgnoDataUnidad, String>(
                              ...
                              dataSource: _getProduccionDataAgno(
                                  produccion), // Obtiene los datos de producción por año
                              xValueMapper:
                                  (ProduccionAgnoDataUnidad data, _) =>
                                      data.agno, // Mapeo de datos para el eje X
                              yValueMapper: (ProduccionAgnoDataUnidad data,
                                      _) =>
  ...
  List<ProduccionAgnoDataUnidad> _getProduccionDataAgno(
    ...
    for (var produccion in producciones) {
      ...
      // Verifica si la producción  es de los últimos 3 años
    ...
    // Convierte el mapa a una lista de objetos ProduccionAgnoDataUnidad y la retorna
    return produccionesPorAgno.entries
        .map((entry) => ProduccionAgnoDataUnidad(entry.key, entry.value))
        .toList();
  }
