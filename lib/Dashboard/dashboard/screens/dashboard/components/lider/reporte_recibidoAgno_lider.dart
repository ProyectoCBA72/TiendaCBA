...
class ReporteRecibidoAgnoLider extends StatelessWidget {
  ...
  List<FastLineSeries<ProduccionAgnoDataLider, String>> _buildSeries(
      Map<String, Map<String, double>> data) {
    List<FastLineSeries<ProduccionAgnoDataLider, String>> series = [];
    ...
    data.forEach((unidadProduccion, yearlyData) {
      series.add(
        FastLineSeries<ProduccionAgnoDataLider, String>(
          ...
          // Convertir los datos anuales en una lista de objetos ProduccionAgnoDataLider
