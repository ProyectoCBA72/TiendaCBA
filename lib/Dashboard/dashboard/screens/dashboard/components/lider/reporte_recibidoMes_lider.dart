...
class ReporteRecibidoMesLider extends StatelessWidget {
  ...
  List<FastLineSeries<ProduccionMesDataLider, String>> _buildSeries(
      Map<String, Map<String, double>> data) {
    List<FastLineSeries<ProduccionMesDataLider, String>> series = [];
    ...
    data.forEach((unidadProduccion, monthlyData) {
      series.add(
        FastLineSeries<ProduccionMesDataLider, String>(
          ...
          // Convertir los datos mensuales en una lista de objetos ProduccionMesDataLider
