...
class _FacturaLiderState extends State<FacturaLider> {
  ...
  void initState() {
    ...
    _dataGridSource = FacturaLiderDataGridSource(facturas: _facturas);
  }
...
class FacturaLiderDataGridSource extends DataGridSource {
  FacturaLiderDataGridSource({required List<FacturaLiderClase> facturas}) {
