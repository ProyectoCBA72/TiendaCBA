...
class _EventosLiderState extends State<EventosLider> {
  ...
  void initState() {
    ...
    _dataGridSource = EventosLiderDataGridSource(eventos: _eventos);
  }
...
class EventosLiderDataGridSource extends DataGridSource {
  EventosLiderDataGridSource({required List<EventosLiderClase> eventos}) {
