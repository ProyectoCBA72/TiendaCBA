...
// Diseño de la card del conteo de las pedidos las cuales estaran ubicadas en la parte superior de los dashboard
...
/// el título, la línea de progreso y el total de pedidos.
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Icon(
                Icons.more_vert,
                color: primaryColor,
              ), // Ícono de menú desplegable constante
            ],
          ),
          Flexible(
            child: Text(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                info.totalPedidos!, // Total de pedidos dinámico
                style: Theme.of(context).textTheme.bodySmall!.copyWith(
                    color: primaryColor), // Estilo de texto con color primario
              ),
            ],
