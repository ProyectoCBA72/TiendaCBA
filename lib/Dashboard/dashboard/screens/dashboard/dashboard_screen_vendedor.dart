...
class DashboardScreenVendedor extends StatefulWidget {
  const DashboardScreenVendedor({super.key});

  @override
  State<DashboardScreenVendedor> createState() =>
      _DashboardScreenVendedorState();
}

class _DashboardScreenVendedorState extends State<DashboardScreenVendedor> {
